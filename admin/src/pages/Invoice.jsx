          ...
          <div className="bg-white rounded-lg max-w-5xl max-h-[95vh] overflow-y-auto w-full">
            ...
            <div className="p-8 print:p-0" id="invoice-content">
              ...
              <div className="flex justify-between items-start mb-8 pb-6 border-b-2 border-black">
                <div>
                  <h1 className="text-4xl font-bold text-black mb-2">AL-ARIA Perfume Gallery</h1>
                  <div className="text-gray-600 space-y-1">
                    <div className="flex items-center gap-2">
                      <FaMapMarkerAlt className="w-4 h-4" />
                      <span>16 Mitford Tower, 5 Mitford Road, Dhaka 1100, Bangladesh.</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <FaPhone className="w-4 h-4" />
                      <span>+88 01859 549480</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <FaEnvelope className="w-4 h-4" />
                      <span>info@alariabd.com</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-blue-50 p-6 rounded-lg mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800">
                  <div>
                    ...
                    <div>Bank: City Bank Limited PLC.</div>
              ...
              <div className="text-center text-gray-500 text-sm border-t pt-6">
                ...
                <p className="mt-4">
                  ...
                  <span className="text-blue-600">billing@alariabd.com</span> or
                  Call <span className="text-blue-600">+88 01859 549480</span>
                </p>
              </div>
            </div>

...
const InteractiveMap = () => {
  ...
  // Coordinates for Mitford Road, Dhaka
  const position = [40.8176, -73.9482];
  const address = "16 Mitford Tower, 5 Mitford Road, Dhaka 1100, Bangladesh.";
          ...
          <div className="flex-1">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div className="flex items-center gap-2 ">
                ...
                <span className="font-bold text-lg">+88 01859 549480</span>
              </div>
              <div className="flex items-center gap-2">

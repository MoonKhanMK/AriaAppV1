...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-200 to-blue-200 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Container>
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Join AL-ARIA Shopping & Start Your Journey
              </p>
            </div>

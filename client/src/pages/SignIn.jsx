...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 to-gray-200 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Container>
        <div className="sm:w-[450px] w-full mx-auto">
          ...
          >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-3 border ${
                      errEmail ? "border-red-600" : "border-blue-400"
                    } rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-colors`}
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-12 py-3 border ${
                      errPassword ? "border-red-600" : "border-blue-400"
                    } rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-colors`}
                  ...
                  >
                    {showPassword ? (
                      <FaEyeSlash className="h-5 w-5 text-blue-400 hover:text-gray-600" />
                    ) : (
                      <FaEye className="h-5 w-5 text-blue-400 hover:text-gray-600" />
                    )}
                  </button>
                </div>
                {errPassword && (
            ...
            <div className="mt-6 text-center">
              <Link
                to="/signup"
                className="inline-flex items-center gap-2 text-gray-600 hover:text-blue-400 font-medium transition-colors"
              >
                Create New Account

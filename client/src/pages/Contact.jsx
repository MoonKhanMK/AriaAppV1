...
const contactInfo = [
  {
    ...
    content: ["16 Mitford Tower, 5 Mitford Road, Dhaka 1100, Bangladesh."],
  },
  {
    icon: <FaPhone />,
    title: "Call Us",
    content: ["Tel: +88 01859 549480", "(Also WhatsApp)"],
  },
  {
    icon: <FaEnvelope />,
    title: "Email Us",
    content: ["support@alariabd.com", "info@alariabd.com"],
  },
  {
    icon: <FaClock />,
    title: "Business Hours",
    content: ["Saturday - Thursday :", "10:00 AM - 08:00 PM"],
  },
];
                ...
                {!isLoggedIn && (
                  <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                    ...
                    <p className="text-amber-700 mb-3">
                      To Send Us A Message, You Need To Be Logged In To Your Account.
                    </p>
                    <Link
                      to="/signin"
                    ...
                    <div>
                      ...
                      {isLoggedIn && (
                        <p className="mt-1 text-xs text-gray-500">
                          Auto-filled from your profile. Update your profile to change this.
                        </p>
                      )}
                    </div>
                    <div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    store in the heart of Dhaka. Our knowledgeable staff is
                  ...
                  <div className="space-y-4">
                    {loadingMessages ? (
                      ...
                      <div className="text-center py-12">
                        ...
                        <p className="text-gray-600">
                          Your Sent Messages Will Appear Here. Send Your First Message Using The Form Above!
                        </p>
                      </div>
                    ) : (
                      <div className="space-y-4">

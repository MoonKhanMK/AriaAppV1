...
const apiDocumentation = {
  title: "AL-ARIA E-commerce API Documentation",
  version: "1.0.0",
  description: "Complete API Documentation For The AL-ARIA Perfume Gallery e-Commerce Platform",
  baseUrl:
  ...
  try {
    ...
    <body>
      ...
      apiDocumentation.lastUpdated
        ...
        <div class="section">
            <h2>🚀 Quick Start</h2>
            <p>Welcome to the AL-ARIA Perfume Gallery E-commerce API! This RESTful API provides comprehensive functionality for managing users, products, and orders.</p>
        ...
        <footer style="text-align: center; margin-top: 3rem; padding: 2rem; color: #64748b;">
            <p>© 2025 <a href="https://alariabd.com" target="_blank">AL-ARIA Perfume Gallery</a> E-commerce API Documentation.</p>
            <p>Made With 💖 From Dhaka_MK</p>            
        </footer>
    </body>
    </html>
    `;
